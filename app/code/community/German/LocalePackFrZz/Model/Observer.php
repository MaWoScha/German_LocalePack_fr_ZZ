 ...
 */
class German_LocalePackFrZz_Model_Observer {

    public function adminhtmlControllerActionPredispatchStart() {

        $helper = Mage::helper("localepackfrzz");
    ...
    public function getVersionNumber() {
        ...
        return (string)Mage::app()->getConfig()->getNode('modules/German_LocalePackFrZz/version');
    }
    ...
    public function getManageUrl() {
        return Mage::helper("adminhtml")->getUrl('adminhtml/system_config/edit', array('section'=>'localepackfrzz'));
    }
}
